...
+ (NSDictionary *) discoveryParameters
{
    ...
    return @{
             @"serviceId": kTVCastLibNetcastTVServiceId,
             @"ssdp":@{
...
- (void) showPairingDialog
{
    ...
    NSString *message = [[NSBundle mainBundle] localizedStringForKey:@"TVCast_LIB_Pair_Request_Pin" value:@"Please enter the pin code" table:@"TVCastLib"];
...
- (int) sendCommand:(ServiceCommand *)command withPayload:(NSString *)payload toURL:(NSURL *)URL
{
    ...
    [request setValue:@"Apple iOS UDAP/2.0 TVCastLib" forHTTPHeaderField:@"User-Agent"];
