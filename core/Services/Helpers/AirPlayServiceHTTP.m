...
- (instancetype) initWithAirPlayService:(AirPlayService *)service
{
    ...
    if (self)
    {
        ...
        _networkingQueue = dispatch_queue_create("com.TVCastLib.AirPlayServiceHTTP.Networking", DISPATCH_QUEUE_SERIAL);
        _imageProcessingQueue = dispatch_queue_create("com.TVCastLib.AirPlayServiceHTTP.ImageProcessing", DISPATCH_QUEUE_SERIAL);
    }
