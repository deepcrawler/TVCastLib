...
- (void) connect
{
    ...
    } else
    {
        ...
        NSString *title = [[NSBundle mainBundle] localizedStringForKey:@"TVCast_LIB_AirPlay_Mirror_Title" value:@"Mirroring Required" table:@"TVCastLib"];
        NSString *message = [[NSBundle mainBundle] localizedStringForKey:@"TVCast_LIB_AirPlay_Mirror_Description" value:@"Enable AirPlay mirroring to connect to this device" table:@"TVCastLib"];
        NSString *ok = [[NSBundle mainBundle] localizedStringForKey:@"TVCast_LIB_AirPlay_Mirror_OK" value:@"OK" table:@"TVCastLib"];
        NSString *cancel = [[NSBundle mainBundle] localizedStringForKey:@"TVCast_LIB_AirPlay_Mirror_Cancel" value:@"Cancel" table:@"TVCastLib"];
...
{
    if ([request.URL.absoluteString hasPrefix:@"TVCastLib://"])
    {
        NSString *jsonString = [[request.URL.absoluteString componentsSeparatedByString:@"TVCastLib://"] lastObject];
