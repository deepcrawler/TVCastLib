...
{
    return @{
             @"serviceId": kTVCastLibWebOSTVServiceId,
             @"ssdp":@{
...
-(void) showAlert
{
    NSString *title = [[NSBundle mainBundle] localizedStringForKey:@"TVCast_LIB_Pair_Title" value:@"Pairing with device" table:@"TVCastLib"];
    NSString *message = [[NSBundle mainBundle] localizedStringForKey:@"TVCast_LIB_Pair_Request" value:@"Please confirm the connection on your device" table:@"TVCastLib"];
    NSString *ok = [[NSBundle mainBundle] localizedStringForKey:@"TVCast_LIB_Pair_OK" value:@"OK" table:@"TVCastLib"];
    NSString *cancel = [[NSBundle mainBundle] localizedStringForKey:@"TVCast_LIB_Pair_Cancel" value:@"Cancel" table:@"TVCastLib"];
    ...
    if(self.pairingType == DeviceServicePairingTypePinCode || self.pairingType == DeviceServicePairingTypeMixed){
        ...
        _pairingAlert.message = [[NSBundle mainBundle] localizedStringForKey:@"TVCast_LIB_Pair_Request_Pin" value:@"Please enter the pin code" table:@"TVCastLib"];
    }
...
{
    NSString *alertTitle = [[NSBundle mainBundle] localizedStringForKey:@"TVCast_LIB_Pair_Title" value:title table:@"TVCastLib"];
    NSString *alertMessage = [[NSBundle mainBundle] localizedStringForKey:@"TVCast_LIB_Pair_Request" value:message table:@"TVCastLib"];
    NSString *ok = [[NSBundle mainBundle] localizedStringForKey:@"TVCast_LIB_Pair_OK" value:@"OK" table:@"TVCastLib"];
    if(!_pinAlertView){
...
- (void)closeWebApp:(LaunchSession *)launchSession success:(SuccessBlock)success failure:(FailureBlock)failure
{
    ...
    if (webAppSession && webAppSession.connected)
    {
        ...
        NSDictionary *closeCommand = @{
                @"contentType" : @"tvcastlibk.serviceCommand",
                @"serviceCommand" : @{
                        @"type" : @"close"
                }
        };
