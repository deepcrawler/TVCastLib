...
//  TVCastLib
//
//  Created by Hamed Ghaderipour on 2/21/14.
 ...
 *
 * The TVCastLib JavaScript Bridge has been produced to provide normalized support for these capabilities across protocols (Chromecast, webOS, etc).
 */
...
/*!
 * Sends a simple string to the web app. The TVCastLib JavaScript Bridge will receive this message and hand it off as a string object.
 *
 * @param success (optional) SuccessBlock to be called on success
 * @param failure (optional) FailureBlock to be called on failure
 */
...
/*!
 * Sends a JSON object to the web app. The TVCastLib JavaScript Bridge will receive this message and hand it off as a JavaScript object.
 *
 * @param success (optional) SuccessBlock to be called on success
 * @param failure (optional) FailureBlock to be called on failure
 */
