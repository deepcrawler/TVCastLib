...
/*!
 * Delegate which should receive discovery updates. It is not necessary to set this delegate property unless you are implementing your own device picker. TVCastLib provides a default DevicePicker which acts as a DiscoveryManagerDelegate, and should work for most cases.
 *
 ...
 *
 * To disable the ConnectableDeviceStore capabilities of TVCastLib, set this value to nil. This may be done at the time of instantiation with `[DiscoveryManager sharedManagerWithDeviceStore:nil]`.
 */
