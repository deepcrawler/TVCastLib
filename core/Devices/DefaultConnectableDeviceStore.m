...
- (instancetype) init
{
    ...
    if (self)
    {
        ...
        _deviceStoreQueue = dispatch_queue_create("TVCast_LIB_Device_Store", DISPATCH_QUEUE_SERIAL);
        ...
        _deviceStoreFilename = [documents stringByAppendingPathComponent:@"TVCast_LIB_Device_Store.json"];
