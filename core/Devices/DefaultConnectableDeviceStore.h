...
//  TVCastLib
//
//  Created by Hamed Ghaderipour on 3/21/14.
...
/*!
 * DefaultConnectableDeviceStore is an implementation of ConnectableDeviceStore provided by TVCastLib for your convenience. This class will be used by DiscoveryManager as the default ConnectableDeviceStore if no other ConnectableDeviceStore implementation is provided before calling startDiscovery.
 *
 ...
 *
 * ###File Format
 * DefaultConnectableDeviceStore stores data in a JSON file named `TVCast_LIB_Device_Store.json` in the documents directory.
 *
@code
{
                ...
                "66be8e5d-51be-b18f-f733-6c4dc8c97aca": { // each DeviceService discovered is keyed against its UUID
                    {
                        ...
                        "description": {
                            ...
                            "version": "4.1.0",
                            "friendlyName": "My TV",
                            "manufacturer": "Hamed Ghaderipour",
